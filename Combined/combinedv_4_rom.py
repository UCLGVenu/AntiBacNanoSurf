...
from Bending_Limits4_rom import func1
import Light_Absorptions_Test4 as LAT
import function_test4_rom as FT
...
plt.title('Bactericidal Figure of Merit for Pitch/Radius')
plt.show()
