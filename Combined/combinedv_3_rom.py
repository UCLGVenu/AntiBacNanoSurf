...
from Bending_Limits3_rom import func1
import Light_Absorptions_Test3 as LAT
import function_test3_rom as FT
...
plt.title('Bactericidal Figure of Merit for Pitch/Heights')
plt.show()
